    ...
    <div style={{ background: "var(--color-sand-50)" }}>
      ...
      <section className="pt-28 pb-16 px-6 text-center bg-hero-gradient relative overflow-hidden">
        ...
        <div className="container-app mx-auto relative z-10">
          <span className="badge mb-6 text-xs" style={{ background: "rgba(200,149,108,0.15)", color: "var(--color-rose-gold-400)", border: "1px solid rgba(200,149,108,0.3)" }}>CONDITIONS D'UTILISATION</span>
          <h1 className="text-display-lg text-white mb-3">Nos <span className="gradient-text">Engagements</span></h1>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto card-luxury p-10">
          ...
          <Section title="10. Droit applicable">
            ...
            <p className="mt-4">Contact : <a href="mailto:legal@shedrive.ma" className="underline" style={{ color: "var(--color-rose-gold-600)" }}>legal@shedrive.ma</a></p>
          </Section>
        </div>
      </section>
