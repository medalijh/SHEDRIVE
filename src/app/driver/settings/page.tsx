    ...
    <div className="container-app mx-auto pb-28" style={{ background: "var(--color-sand-50)", minHeight: "100vh" }}>
      <div className="px-6 pt-12 pb-4">
        ...
        <div className="card-luxury p-6 flex items-center gap-5 mb-6">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-semibold" style={{ fontFamily: "var(--font-display)" }}>Khadija Moqri</h2>
            <p className="text-sm" style={{ color: "var(--color-muted)" }}>+212 6XX XXX XXX</p>
            <div className="flex flex-wrap items-center gap-2 mt-2">
              <span className="badge badge-success" style={{ fontSize: 10 }}>✓ Approuvée</span>
              <span className="badge badge-warning" style={{ fontSize: 10 }}>⭐ 4.9</span>
              <span className="badge badge-primary" style={{ fontSize: 10 }}>847 trajets</span>
            </div>
          </div>
        </div>
        ...
        <div className="card p-5 mb-5">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              <div className="font-semibold">Dacia Logan · Gris Métallique</div>
              <div className="text-xs" style={{ color: "var(--color-muted)" }}>2022 · 34521 | A · Économique</div>
            </div>
          </div>
      ...
      <div className="px-6 flex flex-col gap-4">
        <div className="card p-5">
          ...
          <Row icon="🟢" label="Mode en ligne" value={isOnline ? "Vous êtes visible par les passagères" : "Vous n'êtes pas visible"} toggle toggled={isOnline} onClick={() => setIsOnline(!isOnline)}/>
        </div>

        <div className="card p-5">
          <h3 className="font-semibold mb-1" style={{ fontFamily: "var(--font-display)" }}>Informations</h3>
          <Row icon="👤" label="Nom complet" value="Khadija Moqri"/>
          <Row icon="📱" label="Téléphone" value="+212 6XX XXX XXX"/>
          <Row icon="📧" label="Email" value="khadija@email.ma"/>
        ...
        <div className="card p-5">
          ...
          {[
            ...
            { icon: "🎫", label: "Permis de conduire", status: "Vérifié · Exp. 2028", ok: true },
            { icon: "🚗", label: "Véhicule", status: "Vérifié", ok: true },
            { icon: "📋", label: "Assurance", status: "Expire dans 3 mois", ok: true },
          ].map(d => (
            <div key={d.label} className="flex items-center gap-4 py-3 border-b last:border-0" style={{ borderColor: "var(--color-border)" }}>
              ...
              <div className="flex-1">
                ...
                <div className="text-xs" style={{ color: "var(--color-muted)" }}>{d.status}</div>
              </div>
